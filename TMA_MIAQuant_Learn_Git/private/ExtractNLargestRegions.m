...
function binaryImage = ExtractNLargestRegions(binaryImage, numberToExtract)
try
  ...
  biggestR = ismember(labeledImage, sortIndexes(1:numberToExtract));
  % Convert from integer labeled image into binary (logical) image.
  binaryImage = biggestR > 0;
catch ME
